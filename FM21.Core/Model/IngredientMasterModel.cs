...
{
    public class IngredientMasterModel
    {
        ...
        public string AlertReviewCaption { get; set; }
        ...
        public string UsageAlertCaption { get; set; }
        public string ExclusivityAlert { get; set; }
        public string ExclusivityAlertCaption { get; set; }
        ...
        [Ignore]
        public int[] AllergenInfo { get; set; }
        [Ignore]
        ...
        [Ignore]
        public string ANJCode { get; set; }
        [Ignore]
        public string ANACode { get; set; }
        [Ignore]
        public string SLCCode { get; set; }
        [Ignore]
        public int NutrientIngredientID { get; set; }
    }
}