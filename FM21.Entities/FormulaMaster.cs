...
namespace FM21.Entities
{
    ...
    public class FormulaMaster
    {
        public FormulaMaster()
        {
            ...
            FormulaDetailMapping = new HashSet<FormulaDetailMapping>();
            FormulaProductionLineMapping = new HashSet<FormulaProductionLineMapping>();
            FormulaRevision = new HashSet<FormulaRevision>();
        }
        ...
        public virtual Customer FormulaCustomer { get; set; }
        public virtual ProjectMaster FormulaProject { get; set; }
        public virtual FormulaTypeMaster FormulaType { get; set; }
        public virtual DatasheetFormatMaster NutrientFormat { get; set; }
        public virtual PowderBlenderMaster PowderBlender { get; set; }
        public virtual PowderLiquidMaster PowderLiquidAmount { get; set; }
        public virtual UnitServingMaster PowderUnit { get; set; }
        public virtual FormulaRegulatoryCategoryMaster RegulatoryCategory { get; set; }
        ...
        public virtual ICollection<FormulaDetailMapping> FormulaDetailMapping { get; set; }
        public virtual ICollection<FormulaProductionLineMapping> FormulaProductionLineMapping { get; set; }
        public virtual ICollection<FormulaRevision> FormulaRevision { get; set; }
        public virtual SiteProductionLineMapping SiteProductionLineMapping { get; set; }
    }
}